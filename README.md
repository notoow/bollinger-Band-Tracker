...
The public site uses [giscus](https://giscus.app/) for GitHub Discussions-powered comments. This keeps the site static and avoids a custom OAuth flow.

1. Enable Discussions in the repository.
2. Install/enable the giscus GitHub App for this repository.
3. Open `https://giscus.app/`, enter `notoow/bollinger-Band-Tracker`, choose a discussion category, and copy the generated values.
