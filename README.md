...
공개 페이지에는 `utterances` 댓글 패널이 포함되어 있습니다. 댓글은 이 저장소의 GitHub
Issues에 저장되고, 페이지 경로마다 하나의 이슈가 생성됩니다. 댓글 이슈에는 `community`
라벨이 붙습니다.

댓글 작성을 켜려면 이 저장소에 utterances GitHub App을 설치하세요:
https://github.com/apps/utterances

저장소는 공개 상태여야 하고, 댓글을 남기는 방문자는 GitHub 계정으로 로그인해야 합니다.
